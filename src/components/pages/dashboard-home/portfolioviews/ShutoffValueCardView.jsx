...
function ShutoffValue(props) {
   ...
   //refresh the component for every 1 mins to update the shut off valve card
   useEffect(() => {
   ...
   var TodayRecord = incidents.filter(item => item.displayName === "Shuttie Stuck" && item.startTime < PreviousDate)
      ...
      <>
         <div className='card dashboard-card'>
            <div className='card-header'>
               <div className='text-primary'><b>Shut-off Valve</b></div>
            </div>
            <div className='card-body'>
               <div className='d-flex justify-content-between px-3 py-2'>
                  <span className='h2'> {TodayRecord.length}</span>  <img src={process.env.PUBLIC_URL + '/images/dashboard/ShutoffValve_view.png'} />
               </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(ShutoffValue);