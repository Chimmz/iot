...
const HighestwaterCost = (props) => {
   ...
   const xAxisTitle = "Water Cost (dollars)";
   const yAxisTitle = "Highlighted Location";
   ...
   return (
       ...
       <div className='card'>
         <div className='card-header'>
            <div className='text-primary'><b>Highest Water Cost</b></div>
         </div>
...
export default HighestwaterCost