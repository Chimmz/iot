...
function WaterFloodView(props) {
   ...
   var TodayRecord = incidents.filter(item => item.displayName === "Flood" && item.startTime < PreviousDate)
      ...
      <>
         <div className='card dashboard-card'>
            <div className='card-header'>
               <div className='text-primary'><b>Water Flood</b></div>
            </div>
            <div className='card-body'>
               <div className='d-flex justify-content-between px-3 py-2'>
                  <span className='h2'> {TodayRecord.length}</span>
                  <img src={process.env.PUBLIC_URL + '/images/dashboard/WaterFlood_live.png'} />
               </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(WaterFloodView);